...
public class CustomTextView extends AppCompatTextView {
    ...
    public void setCustomFont(final Context mContext, final AttributeSet attrs) {
        @SuppressLint("CustomViewStyleable") final TypedArray mTypedArray = mContext.obtainStyledAttributes(attrs, R.styleable.CustomTextView);
        int font = mTypedArray.getInteger(R.styleable.CustomTextView_fontName, R.integer.fontGothamBook);
